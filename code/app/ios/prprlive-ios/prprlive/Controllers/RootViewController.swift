...
class RootViewController: BaseViewController, RootViewControllerDelegate {
    ...
    func setupPeopleNavigationItems() {
        ...
        leftButton.addTarget(self, action: "searchButtonItemPressed:", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        rightButton.addTarget(self, action: "profileButtonItemPressed:", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func setupMainNavigationItems() {
        ...
        button.addTarget(self, action: "modeChanged", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    override func viewDidLoad() {
        ...
        // Ask for use Camera
        if AVCaptureDevice.respondsToSelector("requestAccessForMediaType:completionHandler:") {
