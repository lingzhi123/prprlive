...
class Config: NSObject {
    ...
    func amazon() -> (accessKeyId: String, secretAccessKey: String, streamBucket: String, imagesBucket: String) {
        ...
        return (accessKeyId, secretAccessKey, streamBucket, imagesBucket)
    }
