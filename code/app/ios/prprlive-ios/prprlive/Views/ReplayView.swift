...
class ReplayView: UIView {
    ...
    override func awakeFromNib() {
        ...
        viewersButton.addTarget(self, action: "viewersButtonPressed:", forControlEvents: UIControlEvents.TouchUpInside)
        replaysButton.addTarget(self, action: "replaysButtonPressed:", forControlEvents: UIControlEvents.TouchUpInside)
